...
- **[API.market MCP Gateway](https://api.market/mcp)**: Proprietary hosted service with five tools for API discovery, execution, usage checks, and subscription management at `https://api.market/api/mcp/gateway`. Requires an account and OAuth or an API key; pricing and quotas vary by API.
